...
Public Class NewSupplyOrder
    ...
    Private Sub NewSupplyOrder_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub VendorComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles VendorComboBox.SelectedIndexChanged
        ...
        Dim sqlCmd As SqlCommand = chConn.CreateCommand()
        With sqlCmd
            .CommandText = "SELECT DISTINCT i.Item_ID, RTRIM(i.[Description]) as Description FROM ITEM i INNER JOIN VENDOR v ON i.Vendor_ID = v.Vendor_ID WHERE Type = 'Supply' AND v.Vendor_Name = '" & vendorCd & "'"
        End With
    ...
    Private Sub ItemComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ItemComboBox.SelectedIndexChanged
        ...
        With sqlCmd
            ...
            priceTextBox.Text = .ExecuteScalar()
        End With
        chConn.Close()
    ...
    Private Sub addToOrderButton_Click(sender As Object, e As EventArgs) Handles addToOrderButton.Click
        ...
        SupplyOrderDataGridView.DataSource = objDataSet.Tables(0)
    ...
    Private Sub submitOrderButton_Click(sender As Object, e As EventArgs) Handles submitOrderButton.Click
        ...
        With sqlCmd
            ...
            OrderTotalTextBox.Text = orderTotal
